package com.solitardj9.userProfile.application.userManager.model;
...
public class User {
	...
	public void mergeAttributes(String attributes) {
		...
		try {
			...
			logger.error("[User].setAttributes : error = " + e);
		}
	}
	...
	public Integer findAttributeAsInteger(String keyPath) {
		...
		try {
			...
			logger.error("[User].findAttributeAsInteger : error = " + e);
			return null;
		}
	}
